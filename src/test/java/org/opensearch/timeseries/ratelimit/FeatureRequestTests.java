...
public class FeatureRequestTests extends OpenSearchTestCase {
    ...
    public void testCheckpointReadOverloadRetryCountStartsAtZeroAndIncrements() {
        Entity mockEntity = mock(Entity.class);
        when(mockEntity.getModelId(null, CONFIG_ID)).thenReturn(Optional.of("model-123"));
        ...
        assertEquals(0, req.getCheckpointReadOverloadRetryCount());
        req.incrementCheckpointReadOverloadRetryCount();
        assertEquals(1, req.getCheckpointReadOverloadRetryCount());
    }
}

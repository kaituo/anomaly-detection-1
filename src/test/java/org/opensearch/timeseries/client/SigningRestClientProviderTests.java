...
public class SigningRestClientProviderTests extends OpenSearchTestCase {
    ...
    public void testCacheSeparatesTrafficClassesForSameEndpointRegionServiceAndCredentialsProvider() {
        String endpoint = "http://127.0.0.1:19293";
        AwsCredentialsProvider credentialsProvider = StaticCredentialsProvider.create(AwsBasicCredentials.create("access", "secret"));

        RestClient foregroundClient = SigningRestClientProvider.getRestClient(endpoint, "us-west-2", credentialsProvider, "aoss");
        RestClient backgroundClient = SigningRestClientProvider
        ...
        RestClient backgroundClientAgain = SigningRestClientProvider
            .getRestClientForTrafficClass(
                endpoint,
                "us-west-2",
                credentialsProvider,
        ...
        assertSame(backgroundClient, backgroundClientAgain);
    }
}

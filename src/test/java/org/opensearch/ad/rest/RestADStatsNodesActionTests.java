...
public class RestADStatsNodesActionTests extends OpenSearchTestCase {
    ...
    private FakeRestRequest createRequest(Map<String, List<String>> headers) {
        ...
        builder.withPath(TimeSeriesAnalyticsPlugin.AD_BASE_INTERNAL_DETECTORS_URI + "/_stats/nodes/ad_execute_request_count");
        builder.withParams(Map.of("nodeId", "_all", "stat", StatNames.AD_EXECUTE_REQUEST_COUNT.getName()));

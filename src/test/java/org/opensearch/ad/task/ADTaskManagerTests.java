...
public class ADTaskManagerTests extends AbstractTimeSeriesTest {
    ...
    @SuppressWarnings("unchecked")
    public void testGetAndExecuteOnLatestADTasksTreatsSdkSearchPhaseFailureAsEmpty() {
        String detectorId = randomAlphaOfLength(5);
        Consumer<List<ADTask>> function = mock(Consumer.class);
        ActionListener<JobResponse> listener = mock(ActionListener.class);
        ...
        verify(function).accept(argThat(List::isEmpty));
        verify(listener, never()).onFailure(any());
    }

    @SuppressWarnings("unchecked")
    public void testUpdateLatestFlagOfOldTasksAndCreateNewTaskTreatsSdkSearchPhaseFailureAsNoOldTasks() throws IOException {
        doAnswer(invocation -> {

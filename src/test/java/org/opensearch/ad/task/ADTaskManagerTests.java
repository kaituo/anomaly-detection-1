...
public class ADTaskManagerTests extends AbstractTimeSeriesTest {
    ...
    public void setUp() throws Exception {
        ...
        taskSearcher = new DefaultDataAccess(client, clusterService, mock(SecurityClientUtil.class), mock(org.opensearch.cluster.metadata.IndexNameExpressionResolver.class));
    ...
    public void testStopConfigListener_onResponse_failure() throws Exception {
        ...
        verify(adTaskManager, times(1))
            .stopLatestRealtimeTask(eq(configId), eq((String) null), eq(TaskState.FAILED), exceptionCaptor.capture(), eq(transportService), eq(listener));

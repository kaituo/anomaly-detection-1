...
public class ADResultBulkResponseTests extends OpenSearchTestCase {
    public void testSerialization() throws IOException {
        ...
        TimeSeriesResultBulkResponse response = new TimeSeriesResultBulkResponse(retryRequests);
        response.writeTo(output);
        StreamInput streamInput = output.bytes().streamInput();
        TimeSeriesResultBulkResponse readResponse = new TimeSeriesResultBulkResponse(streamInput);

...
public class AnomalyResultHandlerTests extends AbstractIndexHandlerTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        super.setUpLog4jForJUnit(TimeSeriesIndexHandler.class);
    }
    ...
    public void testSavingAdResult() throws IOException {
        ...
        TimeSeriesIndexHandler<AnomalyResult> handler = new TimeSeriesIndexHandler<AnomalyResult>(
            client,
            settings,
            threadPool,
        ...
        assertEquals(1, testAppender.countMessage(TimeSeriesIndexHandler.SUCCESS_SAVING_MSG, true));
    }
    ...
    public void testSavingFailureNotRetry() throws InterruptedException, IOException {
        ...
        assertEquals(1, testAppender.countMessage(TimeSeriesIndexHandler.FAIL_TO_SAVE_ERR_MSG, true));
        assertTrue(!testAppender.containsMessage(TimeSeriesIndexHandler.SUCCESS_SAVING_MSG, true));
        assertTrue(!testAppender.containsMessage(TimeSeriesIndexHandler.RETRY_SAVING_ERR_MSG, true));
    }
    ...
    public void testSavingFailureRetry() throws InterruptedException, IOException {
        ...
        assertEquals(2, testAppender.countMessage(TimeSeriesIndexHandler.RETRY_SAVING_ERR_MSG, true));
        assertEquals(1, testAppender.countMessage(TimeSeriesIndexHandler.FAIL_TO_SAVE_ERR_MSG, true));
        assertTrue(!testAppender.containsMessage(TimeSeriesIndexHandler.SUCCESS_SAVING_MSG, true));
    }
    ...
    public void testIndexWriteBlock() {
        ...
        assertTrue(testAppender.containsMessage(TimeSeriesIndexHandler.CANNOT_SAVE_ERR_MSG, true));
    }

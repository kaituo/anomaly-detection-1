...
public class AnomalyResultBulkIndexHandlerTests extends ADUnitTestCase {
    ...
    public void testAnomalyResultBulkIndexHandler_IndexNotExist() {
        when(anomalyDetectionIndices.doesResultIndexExists(eq("testIndex"), any())).thenReturn(false);
        when(anomalyDetectionIndices.doesResultAliasExists(eq("testIndex"), any())).thenReturn(false);
    ...
    public void testAnomalyResultBulkIndexHandler_InValidResultIndexMapping() {
        when(anomalyDetectionIndices.doesResultIndexExists(eq("testIndex"), any())).thenReturn(true);
        doAnswer(invocation -> {
    ...
    public void testResourceAlreadyExistsException() {
        String testIndex = "testIndex";
        when(anomalyDetectionIndices.doesResultIndexExists(eq(testIndex), any())).thenReturn(false, true);
        when(anomalyDetectionIndices.doesResultAliasExists(eq(testIndex), any())).thenReturn(false, false);
    ...
    public void testTimeSeriesExceptionCaughtInBulk() {
        ...
        when(anomalyDetectionIndices.doesResultIndexExists(eq(testIndex), any())).thenThrow(testException);

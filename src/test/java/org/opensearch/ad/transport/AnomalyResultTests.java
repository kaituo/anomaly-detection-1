...
public class AnomalyResultTests extends AbstractTimeSeriesTest {
    ...
    public void testOnFailureNull() throws IOException {
        ADResultProcessor adResultProcessor = new ADResultProcessor(
        ...
        ADResultProcessor.RCFActionListener listener = adResultProcessor.new RCFActionListener(
    ...
    public void testNormalRCFResult() {
        ...
        ADResultProcessor.RCFActionListener rcfListener = adResultProcessor.new RCFActionListener(

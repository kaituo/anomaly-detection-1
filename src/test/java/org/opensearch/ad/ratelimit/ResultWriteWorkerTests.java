...
public class ResultWriteWorkerTests extends AbstractRateLimitingTest {
    ...
    public void setUp() throws Exception {
        ...
        resultHandler = mock(ADHCResultHandler.class);
    ...
    public void testRegular() {
        ...
        TimeSeriesResultBulkResponse resp = new TimeSeriesResultBulkResponse(retryRequests);
        ...
        doAnswer(invocation -> {
            ActionListener<TimeSeriesResultBulkResponse> listener = invocation.getArgument(1);

...
public class CheckpointDaoTests extends OpenSearchTestCase {
    ...
    @SuppressWarnings("unchecked")
    public void test_putModelCheckpoint_persistDetectorId_whenTenantIdProvided() {
        String modelId = SingleStreamModelIdMapper.getRcfModelId("testTenant", "testDetector", 0);
        ArgumentCaptor<UpdateRequest> requestCaptor = ArgumentCaptor.forClass(UpdateRequest.class);
        doAnswer(invocation -> {
            ActionListener<UpdateResponse> listener = invocation.getArgument(2);
            listener.onResponse(null);
        ...
        checkpointDao.putTRCFCheckpoint(modelId, createTRCF(), mock(ActionListener.class));

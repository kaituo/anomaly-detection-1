...
public class HashRingTests extends ADUnitTestCase {
    ...
    public void setUp() throws Exception {
        ...
        nodeFilter = spy(new DiscoveryNodeFilterer(clusterService, mock(org.opensearch.cluster.metadata.IndexNameExpressionResolver.class)));
    ...
    public void testBuildCirclesDoesNotForceAddLocalUuidWhenAddressKeyExists() throws UnknownHostException {
        ...
        assertTrue("First build should still include local uuid key before map is populated", asList(requestedNodeIds.get(0)).contains(localUuid));

...
public class ClusterManagerEventListenerTests extends AbstractTimeSeriesTest {
    ...
    private CheckpointDaoInterface<?> adCheckpointStore;
    ...
    public void setUp() throws Exception {
        ...
        adCheckpointStore = mock(CheckpointDaoInterface.class);
    ...
    public void testOnOffClusterManager() {
        ...
        when(adCheckpointStore.createRetentionTask(any(), any())).thenReturn(() -> {});
        when(forecastCheckpointStore.createRetentionTask(any(), any())).thenReturn(() -> {});

        ClusterManagerEventListener clusterManagerService = new ClusterManagerEventListener(client, adCheckpointStore, forecastCheckpointStore);
        ...
        verify(adCheckpointStore).createRetentionTask(any(), any());
        verify(forecastCheckpointStore).createRetentionTask(any(), any());

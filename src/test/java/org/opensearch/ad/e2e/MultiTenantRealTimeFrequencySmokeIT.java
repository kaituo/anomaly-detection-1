...
public class MultiTenantRealTimeFrequencySmokeIT extends RealTimeFrequencySmokeIT {
    private static final String MODEL_CLUSTER_PROPERTY = "tests.model.rest.cluster";

    private final String multiTenantId = "tenant-frequency-smoke-" + randomAlphaOfLength(6).toLowerCase(Locale.ROOT);
    private final String datasetName = "simple-rt-frequency-" + randomAlphaOfLength(8).toLowerCase(Locale.ROOT);

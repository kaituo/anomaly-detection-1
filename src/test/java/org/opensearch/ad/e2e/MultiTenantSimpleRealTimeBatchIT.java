...
public class MultiTenantSimpleRealTimeBatchIT extends SimpleRealTimeBatchIT {
    private static final String MODEL_CLUSTER_PROPERTY = "tests.model.rest.cluster";

    private final String multiTenantId = "tenant-simple-rt-batch-" + randomAlphaOfLength(6).toLowerCase(Locale.ROOT);
    private final String datasetName = "simple-rt-batch-" + randomAlphaOfLength(8).toLowerCase(Locale.ROOT);

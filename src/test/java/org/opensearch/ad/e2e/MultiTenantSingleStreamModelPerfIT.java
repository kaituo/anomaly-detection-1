...
public class MultiTenantSingleStreamModelPerfIT extends SingleStreamModelPerfIT {
    private static final String MODEL_CLUSTER_PROPERTY = "tests.model.rest.cluster";

    private final String multiTenantId = "tenant-single-stream-model-" + randomAlphaOfLength(6).toLowerCase(Locale.ROOT);
    private final String datasetName = "single-stream-model-" + randomAlphaOfLength(8).toLowerCase(Locale.ROOT);

...
public class ForecastTaskManagerTests extends AbstractTimeSeriesTest {
    ...
    public void setup() throws Exception {
        ...
        DataAccess taskSearcher = new DefaultDataAccess(client, clusterService, mock(SecurityClientUtil.class), mock(org.opensearch.cluster.metadata.IndexNameExpressionResolver.class));

...
public class CommonName {
    ...
    public static final String DATA_SOURCE_ID_FIELD = "dataSourceId";
    /** The field name containing the tenant id */
    public static final String TENANT_ID_FIELD = "tenant_id";
    /** The field name containing the event bridge cell id */
    public static final String EVENT_BRIDGE_CELL_ID_FIELD = "eventBridgeCellId";
    public static final String AOSD_APPLICATION_ID_HEADER = "x-amzn-aosd-application-id";
    public static final String AOSD_DATA_SOURCE_ID_HEADER = "x-amzn-datasource-id";

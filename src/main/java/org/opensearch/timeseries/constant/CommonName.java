...
public class CommonName {
    ...
    public static final String CONFIG_JSON_FIELD = "config_json";
    ...
    // multi-tenant
    // ======================================
    /** The field name containing the application id */
    public static final String APPLICATION_ID_FIELD = "application_id";
    /** The field name containing the data source id */
    public static final String DATA_SOURCE_ID_FIELD = "data_source_id";
    /** The field name containing the workspace id */
    public static final String WORKSPACE_ID_FIELD = "workspace_id";
    /** The field name containing the tenant id */
    public static final String TENANT_ID_FIELD = "tenant_id";
    /** The field name containing the event bridge cell id */
    public static final String EVENT_BRIDGE_CELL_ID_FIELD = "event_bridge_cell_id";
    /** The field name containing an S3 checkpoint reference */
    public static final String S3_REFERENCE_FIELD = "s3_reference";
    public static final String AOSD_APPLICATION_ID_HEADER = "x-opensearch-timeseries-application-id";
    public static final String AOSD_DATA_SOURCE_ID_HEADER = "x-opensearch-timeseries-data-source-id";
    public static final String TENANT_ID_HEADER = "x-tenant-id";
    public static final String INTERNAL_API_TOKEN_HEADER = "x-timeseries-internal-token";

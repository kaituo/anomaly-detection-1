...
public class TimeSeriesMemoryTracker {
    private static final Logger LOG = LogManager.getLogger(TimeSeriesMemoryTracker.class);

    public enum Origin {
        SINGLE_ENTITY_DETECTOR,
        HC_DETECTOR,
        HISTORICAL_SINGLE_ENTITY_DETECTOR,
        REAL_TIME_SINGLE_STRAEM_FORECASTER,
        REAL_TIME_HC_FORECASTER
    }
     ...
     */
    public TimeSeriesMemoryTracker(
        JvmService jvmService,
        double modelMaxSizePercentage,
        double modelDesiredSizePercentage,
        ClusterService clusterService,
        TimeSeriesCircuitBreakerService timeSeriesCircuitBreakerService
    ) {

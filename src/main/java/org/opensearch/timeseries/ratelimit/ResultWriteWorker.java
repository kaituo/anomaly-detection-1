...
public abstract class ResultWriteWorker<ResultType extends IndexableResult, ResultWriteRequestType extends ResultWriteRequest<ResultType>, BatchRequestType extends ResultBulkRequest<ResultType, ResultWriteRequestType>, NodeStateType extends NodeState, NodeStateManagerType extends NodeStateManager<NodeStateType>, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, ResultHandlerType extends IndexMemoryPressureAwareResultHandler<BatchRequestType, ResultBulkResponse, IndexType, IndexManagementType>>
    extends BatchWorker<ResultWriteRequestType, BatchRequestType, ResultBulkResponse, NodeStateType, NodeStateManagerType> {

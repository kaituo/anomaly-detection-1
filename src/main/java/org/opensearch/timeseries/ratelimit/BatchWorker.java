 ...
 */
public abstract class BatchWorker<RequestType extends QueuedRequest, BatchRequestType, BatchResponseType, NodeStateType extends NodeState>
    extends ConcurrentWorker<RequestType, NodeStateType> {

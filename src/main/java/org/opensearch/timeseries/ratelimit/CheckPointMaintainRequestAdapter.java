 ...
 *
 */
public class CheckPointMaintainRequestAdapter<RCFModelType extends ThresholdedRandomCutForest, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, CheckpointDaoType extends CheckpointDao<RCFModelType, IndexType, IndexManagementType>> {
    private static final Logger LOG = LogManager.getLogger(CheckPointMaintainRequestAdapter.class);
    private BiFunction<String, String, Optional<ModelState<RCFModelType>>> getStateToMaintain;
    ...
    public CheckPointMaintainRequestAdapter(
        BiFunction<String, String, Optional<ModelState<RCFModelType>>> getStateToMaintain,
    ...
    public Optional<CheckpointWriteRequest> convert(CheckpointMaintainRequest request) {
        ...
        Optional<ModelState<RCFModelType>> stateToMaintain = getStateToMaintain.apply(detectorId, modelId);

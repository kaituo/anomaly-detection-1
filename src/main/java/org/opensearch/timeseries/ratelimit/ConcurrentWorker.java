 ...
 */
public abstract class ConcurrentWorker<RequestType extends QueuedRequest, NodeStateType extends ExpiringState> extends RateLimitedRequestWorker<RequestType, NodeStateType> {

...
public abstract class TimeSeriesResultWriteWorker<ResultType extends AnalysisResult, ResultWriteRequestType extends ResultWriteRequest<ResultType>, BatchRequestType extends TimeSeriesResultBulkRequest<ResultType, ResultWriteRequestType>, NodeStateType extends ExpiringState>
    ...
    protected final TimeSeriesIndexHandler<ResultType, BatchRequestType, TimeSeriesResultBulkResponse> resultHandler;
    ...
    public TimeSeriesResultWriteWorker(String queueName, long heapSize, int singleRequestSize,
            ...
            TimeSeriesIndexHandler<ResultType, BatchRequestType, TimeSeriesResultBulkResponse> resultHandler,

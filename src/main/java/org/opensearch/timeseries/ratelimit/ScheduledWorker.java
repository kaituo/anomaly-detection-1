...
public abstract class ScheduledWorker<RequestType extends QueuedRequest, TransformedRequestType extends QueuedRequest, NodeStateType extends NodeState,
    NodeStateManagerType extends NodeStateManager<NodeStateType>>
    extends RateLimitedRequestWorker<RequestType, NodeStateType, NodeStateManagerType> {
    ...
    private final RateLimitedRequestWorker<TransformedRequestType, NodeStateType, NodeStateManagerType> targetQueue;
    ...
    public ScheduledWorker(
        ...
        RateLimitedRequestWorker<TransformedRequestType, NodeStateType, NodeStateManagerType> targetQueue,
        Duration stateTtl,

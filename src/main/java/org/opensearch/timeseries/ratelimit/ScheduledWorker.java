...
public abstract class ScheduledWorker<RequestType extends QueuedRequest, TransformedRequestType extends QueuedRequest, NodeStateType extends ExpiringState> extends
    RateLimitedRequestWorker<RequestType, NodeStateType> {
    ...
    private final RateLimitedRequestWorker<TransformedRequestType, NodeStateType> targetQueue;
    ...
    public ScheduledWorker(
        ...
        RateLimitedRequestWorker<TransformedRequestType, NodeStateType> targetQueue,
        Duration stateTtl,

...
public abstract class TimeSeriesCheckpointWriteWorker<NodeStateType extends ExpiringState, RCFModelType,
    CheckpointDaoType extends TimeSeriesCheckpointDao<RCFModelType>>
        extends BatchWorker<CheckpointWriteRequest, BulkRequest, BulkResponse, NodeStateType> {
    ...
    public TimeSeriesCheckpointWriteWorker(String queueName, long heapSize, int singleRequestSize,
            ...
            TimeSeriesNodeStateManager<NodeStateType> timeSeriesNodeStateManager, CheckpointDaoType checkpoint,

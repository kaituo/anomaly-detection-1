...
public abstract class CheckpointWriteWorker<NodeStateType extends NodeState, NodeStateManagerType extends NodeStateManager<NodeStateType>, RCFModelType, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, CheckpointDaoType extends CheckpointDao<RCFModelType, IndexType, IndexManagementType>>
    extends BatchWorker<CheckpointWriteRequest, BulkRequest, BulkResponse, NodeStateType, NodeStateManagerType> {
    ...
    public CheckpointWriteWorker(
        ...
        Duration stateTtl,
        NodeStateManagerType timeSeriesNodeStateManager,

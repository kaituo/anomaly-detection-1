...
public abstract class ColdStartWorker<NodeStateType extends NodeState, NodeStateManagerType extends NodeStateManager<NodeStateType>, RCFModelType extends ThresholdedRandomCutForest, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, CheckpointDaoType extends CheckpointDao<RCFModelType, IndexType, IndexManagementType>, CheckpointWriteWorkerType extends CheckpointWriteWorker<NodeStateType, NodeStateManagerType, RCFModelType, IndexType, IndexManagementType, CheckpointDaoType>, ColdStarterType extends ModelColdStart<NodeStateType, RCFModelType, IndexType, IndexManagementType, CheckpointDaoType, CheckpointWriteWorkerType>, CacheType extends TimeSeriesCache<RCFModelType>>
    extends SingleRequestWorker<FeatureRequest, NodeStateType, NodeStateManagerType> {
    ...
    protected void executeRequest(FeatureRequest coldStartRequest, ActionListener<Void> listener) {
        ...
        ActionListener<Void> coldStartListener = ActionListener.wrap(r -> {
            nodeStateManager.getConfig(configId, ActionListener.wrap(configOptional -> {
                try {

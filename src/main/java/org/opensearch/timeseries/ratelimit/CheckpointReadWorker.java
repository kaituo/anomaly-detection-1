...
public abstract class CheckpointReadWorker<NodeStateType extends NodeState, RCFModelType extends ThresholdedRandomCutForest, ResultType extends IndexableResult, ResultWriteRequestType extends ResultWriteRequest<ResultType>, ResultWriteBatchRequestType extends ResultBulkRequest<ResultType, ResultWriteRequestType>, RCFResultType extends IntermediateResult, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, CheckpointType extends CheckpointDao<RCFModelType, IndexType, IndexManagementType>, CheckpointWriteWorkerType extends CheckpointWriteWorker<NodeStateType, RCFModelType, IndexType, IndexManagementType, CheckpointType>, ColdStarterType extends ModelColdStart<NodeStateType, RCFModelType, IndexType, IndexManagementType, CheckpointType, CheckpointWriteWorkerType>, ModelManagerType extends ModelManager<RCFModelType, NodeStateType, RCFResultType, IndexType, IndexManagementType, CheckpointType, CheckpointWriteWorkerType, ColdStarterType>, CacheType extends Cache<RCFModelType>, ColdStartWorkerType extends ColdStartWorker<NodeStateType, RCFModelType, IndexType, IndexManagementType, CheckpointType, CheckpointWriteWorkerType, ColdStarterType, CacheType>, ResultHandlerType extends IndexMemoryPressureAwareResultHandler<ResultWriteBatchRequestType, ResultBulkResponse, IndexType, IndexManagementType>, ResultWriteWorkerType extends ResultWriteWorker<ResultType, ResultWriteRequestType, ResultWriteBatchRequestType, NodeStateType, IndexType, IndexManagementType, ResultHandlerType>>
    extends BatchWorker<FeatureRequest, MultiGetRequest, MultiGetResponse, NodeStateType> {
    ...
    protected final HCCacheProvider<RCFModelType> cacheProvider;
    ...
    public CheckpointReadWorker(
        ...
        NodeStateManager<NodeStateType> stateManager,
        IndexManagementType indexUtil,
        HCCacheProvider<RCFModelType> cacheProvider,
        Duration stateTtl,
    ...
    protected void processCheckpointIteration(
        ...
        try {
            ...
            String configId = origRequest.getConfigId();
            Optional<Entity> entity = origRequest.getEntity();

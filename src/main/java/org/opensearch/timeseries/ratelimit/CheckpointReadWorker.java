...
public abstract class CheckpointReadWorker<NodeStateType extends NodeState, NodeStateManagerType extends NodeStateManager<NodeStateType>, RCFModelType extends ThresholdedRandomCutForest, ResultType extends IndexableResult, ResultWriteRequestType extends ResultWriteRequest<ResultType>, ResultWriteBatchRequestType extends ResultBulkRequest<ResultType, ResultWriteRequestType>, RCFResultType extends IntermediateResult, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, CheckpointType extends CheckpointDao<RCFModelType, IndexType, IndexManagementType>, CheckpointWriteWorkerType extends CheckpointWriteWorker<NodeStateType, NodeStateManagerType, RCFModelType, IndexType, IndexManagementType, CheckpointType>, ColdStarterType extends ModelColdStart<NodeStateType, RCFModelType, IndexType, IndexManagementType, CheckpointType, CheckpointWriteWorkerType>, ModelManagerType extends ModelManager<RCFModelType, NodeStateType, RCFResultType, IndexType, IndexManagementType, CheckpointType, CheckpointWriteWorkerType, ColdStarterType>, CacheType extends TimeSeriesCache<RCFModelType>, ColdStartWorkerType extends ColdStartWorker<NodeStateType, NodeStateManagerType, RCFModelType, IndexType, IndexManagementType, CheckpointType, CheckpointWriteWorkerType, ColdStarterType, CacheType>, ResultHandlerType extends IndexMemoryPressureAwareResultHandler<ResultWriteBatchRequestType, ResultBulkResponse, IndexType, IndexManagementType>, ResultWriteWorkerType extends ResultWriteWorker<ResultType, ResultWriteRequestType, ResultWriteBatchRequestType, NodeStateType, NodeStateManagerType, IndexType, IndexManagementType, ResultHandlerType>>
    extends BatchWorker<FeatureRequest, MultiGetRequest, MultiGetResponse, NodeStateType, NodeStateManagerType> {
    ...
    public CheckpointReadWorker(
        ...
        NodeStateManagerType stateManager,

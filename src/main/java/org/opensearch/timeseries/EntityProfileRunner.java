...
public class EntityProfileRunner extends AbstractProfileRunner {
    ...
    private void validateEntity(
        ...
        // checkpoint
        dataAccess
            .searchWithInjectedSecurity(searchRequest, config.getId(), TenantContext.user(config), analysisType, searchResponseListener);
            ...
            if (jobOp.isPresent()) {
                try {
                    ...
                    if (profilesToCollect.contains(EntityProfileName.ENTITY_INFO)) {
                        ...
                        dataAccess.search(lastSampleTimeRequest, TenantContext.user(config), ActionListener.wrap(searchResponse -> {

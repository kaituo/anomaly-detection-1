...
/**
 * Config store backed by the local transport client.
 */
@SuppressForbidden(reason = "org.opensearch.transport.client.Client usage: Only meant to be used in single-tenant.")
public class TransportConfigDocumentStore implements ConfigDocumentStore {
    private final Client client;

    public TransportConfigDocumentStore(Client client) {

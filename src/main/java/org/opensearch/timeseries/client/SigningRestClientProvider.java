...
public final class SigningRestClientProvider {
    ...
    public static RestClient getRestClient(String endpoint, String region, AwsCredentialsProvider credentialsProvider, String serviceName) {
        ...
        String cacheKey = buildCacheKey(normalizedEndpoint, normalizedRegion, normalizedServiceName, credentialsProvider);
        try {
    ...
    private static String buildCacheKey(String endpoint, String region, String serviceName, AwsCredentialsProvider credentialsProvider) {
        /*
        ...
        return endpoint + "|" + region + "|" + serviceName + "|" + credentialsKey;
    }

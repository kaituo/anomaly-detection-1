...
public class TenantContext {
    ...
    /**
     * Lazily parses the tenant id into application id and data source id.
     *
     * @return pair of application id and data source id, or {@code null} if this context has no tenant id
     */
    public Pair<String, String> getTenantComponents() {

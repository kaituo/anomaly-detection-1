...
public interface DataAccess {
     ...
     * @param tenantId tenant id when multi-tenancy is enabled; required for SDK-backed get field mappings
     * @param listener listener receiving the get field mappings response
     */

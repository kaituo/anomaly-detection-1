...
public abstract class Config implements Writeable, ToXContentObject {
    ...
    protected Imputer interpolator;
    ...
    static {
        ...
        linearImputer = new LinearUniformImputer();
    }
    ...
    protected Config(String id, Long version, String name, String description, String timeField,
            ...
            TimeConfiguration interval, ImputationOption interpolationOption) {
        ...
        if (interpolationOption.getMethod() == ImputationMethod.FIXED_VALUES && interpolationOption.getDefaultFill().isEmpty()) {
        ...
        this.imputationOption = interpolationOption;
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (imputationOption != null) {
            builder.field(INTERPOLATION_OPTION_FIELD, imputationOption);
        }
        return builder;
    }
    ...
    public Imputer getInterpolator() {
    ...
    private Imputer createInterpolator() {
        Imputer interpolator = null;
        ...
        case ZERO:
            interpolator = zeroImputer;
            break;
        case FIXED_VALUES:
            // we did validate default fill is not empty in the constructor
            interpolator = new FixedValueImputer(imputationOption.getDefaultFill().get());
            break;
        case PREVIOUS:
            interpolator = previousImputer;
            break;
        case LINEAR:
            interpolator = linearImputer;
            break;
        default:
            logger.error("unsupported method: " + imputationOption.getMethod());
            interpolator = new PreviousValueImputer();
            break;
        }
        return interpolator;
    }

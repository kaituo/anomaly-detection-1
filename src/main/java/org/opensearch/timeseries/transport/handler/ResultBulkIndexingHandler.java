 ...
 *
 */
public class ResultBulkIndexingHandler<ResultType extends ToXContentObject, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>>
        ...
        try {
            if (resultIndex != null) {
                ...
                if (!timeSeriesIndices.isValidResultIndexMapping(resultIndex)) {
                    throw new EndRunException(configId, "wrong index mapping of custom AD result index", true);
                }
    ...
    private void bulk(String resultIndex, List<ResultType> anomalyResults, ActionListener<BulkResponse> listener) {

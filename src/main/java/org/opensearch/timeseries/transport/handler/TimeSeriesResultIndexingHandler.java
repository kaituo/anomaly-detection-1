...
public abstract class TimeSeriesResultIndexingHandler<T extends ToXContentObject> {
    private static final Logger LOG = LogManager.getLogger(TimeSeriesResultIndexingHandler.class);
     ...
     */
    public TimeSeriesResultIndexingHandler(
        Client client,
        Settings settings,

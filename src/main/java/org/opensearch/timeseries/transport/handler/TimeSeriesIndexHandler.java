...
public abstract class TimeSeriesIndexHandler<T extends ToXContentObject, BatchRequestType, BatchResponseType> {
    private static final Logger LOG = LogManager.getLogger(TimeSeriesIndexHandler.class);
    ...
    public TimeSeriesIndexHandler(
        ...
        this.savingBackoffPolicy = BackoffPolicy
            .exponentialBackoff(
                    backOffDelaySetting.get(settings),
                    maxRetrySetting.get(settings)
            );

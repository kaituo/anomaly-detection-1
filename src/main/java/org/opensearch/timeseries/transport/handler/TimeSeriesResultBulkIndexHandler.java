...
public class TimeSeriesResultBulkIndexHandler<T extends ToXContentObject> extends TimeSeriesIndexHandler<T> {
    private static final Logger LOG = LogManager.getLogger(TimeSeriesResultBulkIndexHandler.class);

    private TimeSeriesIndices timeseriesIndices;

    public TimeSeriesResultBulkIndexHandler(
        Client client,
        Settings settings,

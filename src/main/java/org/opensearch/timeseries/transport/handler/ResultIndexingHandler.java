...
public class ResultIndexingHandler<ResultType extends ToXContentObject, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>> {

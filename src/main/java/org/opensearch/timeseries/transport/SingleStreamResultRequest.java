...
public class SingleStreamResultRequest extends ActionRequest implements ToXContentObject {
    ...
    public SingleStreamResultRequest(String configId, String modelId, long start, long end, double[] datapoint, boolean isRunOnce) {
        super();
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeBoolean(this.isRunOnce);
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(CommonName.RUN_ONCE_FIELD, isRunOnce);
        builder.endObject();
        return builder;
    }

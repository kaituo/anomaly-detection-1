...
public abstract class TimeSeriesResultResponse extends ActionResponse implements ToXContentObject {
    ...
    public TimeSeriesResultResponse(
     ...
     * @return
     */
    public static <T extends TimeSeriesResultResponse> T create(
            List<FeatureData> features,
            String error,
            Long rcfTotalUpdates,
            Long configInterval,
     ...
     */
    public TimeSeriesResultResponse(StreamInput in) throws IOException {
        super(in);
    }

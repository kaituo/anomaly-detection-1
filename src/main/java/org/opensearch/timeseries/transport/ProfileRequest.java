...
public class ProfileRequest extends BaseNodesRequest<ProfileRequest> {
    ...
    private boolean modelInPriorityCache;
    ...
    public ProfileRequest(StreamInput in) throws IOException {
        ...
        modelInPriorityCache = in.readBoolean();
    }
     ...
     * @param forHC whether the request is for an high-cardinality analysis
     * @param nodes nodes of nodes' profiles to be retrieved
     */
    public ProfileRequest(String configId, Set<ProfileName> profilesToBeRetrieved, boolean forHC, DiscoveryNode... nodes) {
        super(nodes);
        this.configId = configId;
        this.profilesToBeRetrieved = profilesToBeRetrieved;
        this.modelInPriorityCache = forHC;
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeBoolean(modelInPriorityCache);
    }
    ...
    /**
     *
     * @return Whether the models are stored in priority cache. AD single stream models are stored in ModelManager.
     * Other models are stored in priority cache.
     */
    public boolean isModelInPriorityCache() {
        return modelInPriorityCache;
    }
}

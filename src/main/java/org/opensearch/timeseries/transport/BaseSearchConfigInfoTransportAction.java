...
public abstract class BaseSearchConfigInfoTransportAction
    ...
    public BaseSearchConfigInfoTransportAction(TransportService transportService, ActionFilters actionFilters,
            Client client, String searchConfigActionName) {
    ...
    protected void doExecute(
        Task task,
        SearchConfigInfoRequest request,
        ActionListener<SearchConfigInfoResponse> actionListener
    ) {

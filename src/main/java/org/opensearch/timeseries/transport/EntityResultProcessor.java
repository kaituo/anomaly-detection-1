            ...
            for (Entry<Entity, double[]> entityEntry : request.getEntities().entrySet()) {
                ...
                try {
                    ...
                    if (result.getRcfScore() > 0) {
                        List<IndexableResultType> indexableResults = result
                            .toIndexableResults(
                                config,
                        ...
                        for (IndexableResultType resultToSave : indexableResults) {
                            resultWriteQueue
                                .put(
                                    ResultWriteRequest
                                        .create(

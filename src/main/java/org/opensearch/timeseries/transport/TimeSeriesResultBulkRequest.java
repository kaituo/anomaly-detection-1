...
public class TimeSeriesResultBulkRequest<ResultType extends ToXContentObject & Writeable, ResultWriteRequestType extends ResultWriteRequest<ResultType>> extends ActionRequest implements Writeable {
    private final List<ResultWriteRequestType> results;

    public TimeSeriesResultBulkRequest() {
        results = new ArrayList<>();
    }

    public TimeSeriesResultBulkRequest(StreamInput in, Writeable.Reader<ResultWriteRequestType> reader) throws IOException {
        super(in);

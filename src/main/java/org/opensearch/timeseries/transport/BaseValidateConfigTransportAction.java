...
public abstract class BaseValidateConfigTransportAction<IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>>
    ...
    public void validateExecute(
        ...
        Config detector = request.getConfig();
        ...
        checkIndicesAndExecute(detector.getIndices(), () -> {
            try {
                createProcessor(detector, request, user).start(validateListener);
            } catch (Exception exception) {
                String errorMessage = String
                    .format(Locale.ROOT, "Unknown exception caught while validating detector %s", request.getConfig());

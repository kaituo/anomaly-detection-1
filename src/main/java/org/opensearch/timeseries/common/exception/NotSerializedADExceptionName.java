...
public enum NotSerializedADExceptionName {
    ...
    ANOMALY_DETECTION_EXCEPTION_NAME_UNDERSCORE(OpenSearchException.getExceptionName(new TimeSeriesException("", ""))),
    ...
    CANCELLATION_EXCEPTION_NAME_UNDERSCORE(OpenSearchException.getExceptionName(new TaskCancelledException("", ""))),
    DUPLICATE_TASK_EXCEPTION_NAME_UNDERSCORE(OpenSearchException.getExceptionName(new DuplicateTaskException(""))),
    AD_VERSION_EXCEPTION_NAME_UNDERSCORE(OpenSearchException.getExceptionName(new VersionException(""))),
    AD_VALIDATION_EXCEPTION_NAME_UNDERSCORE(OpenSearchException.getExceptionName(new ValidationException("", null, null)));
    ...
    public static Optional<TimeSeriesException> convertWrappedAnomalyDetectionException(
        ...
        for (NotSerializedADExceptionName timeseriesException : values()) {

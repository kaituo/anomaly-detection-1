...
import org.opensearch.ad.breaker.BreakerName;
 ...
 */
public class TimeSeriesCircuitBreakerService {

    private final ConcurrentMap<String, CircuitBreaker> breakers = new ConcurrentHashMap<>();
    private final JvmService jvmService;

    private static final Logger logger = LogManager.getLogger(TimeSeriesCircuitBreakerService.class);
     ...
     */
    public TimeSeriesCircuitBreakerService(JvmService jvmService) {
     ...
     */
    public TimeSeriesCircuitBreakerService init() {

...
import org.opensearch.timeseries.transport.handler.TimeSeriesResultBulkIndexingHandler;
...
public class TimeSeriesAnalyticsPlugin extends Plugin implements ActionPlugin, ScriptPlugin, JobSchedulerExtension {
    ...
    public Collection<Object> createComponents(
        ...
        TimeSeriesCircuitBreakerService adCircuitBreakerService = new TimeSeriesCircuitBreakerService(jvmService).init();

        ADMemoryTracker memoryTracker = new ADMemoryTracker(
            jvmService,
            modelMaxSizePercent,
        ...
        EntityCacheProvider cacheProvider = new EntityCacheProvider();
        ...
        EntityCache cache = new ADPriorityCache(
            checkpoint,
        ...
        ADEntityColdStarter entityColdStarter = new ADEntityColdStarter(
            getClock(),
            threadPool,
            stateManager,
            AnomalyDetectorSettings.NUM_SAMPLES_PER_TREE,
        ...
        ADEntityColdStartWorker coldstartQueue = new ADEntityColdStartWorker(
            heapSizeBytes,
        ...
        ADHCResultHandler multiEntityResultHandler = new ADHCResultHandler(
            client,
            settings,
            threadPool,
            anomalyDetectionIndices,
        ...
        timeSeriesStats = new TimeSeriesStats(stats);
        ...
        // forecast components
        ForecastIndices forecastIndices = new ForecastIndices(
                client,
                clusterService,
                threadPool,
                settings,

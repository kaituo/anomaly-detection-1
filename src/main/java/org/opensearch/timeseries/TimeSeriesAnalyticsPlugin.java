...
import org.opensearch.forecast.rest.RestExecuteForecasterAction;
...
public class TimeSeriesAnalyticsPlugin extends Plugin implements ActionPlugin, ScriptPlugin, JobSchedulerExtension {
    ...
    public List<RestHandler> getRestHandlers(
        ...
        RestExecuteForecasterAction restExecuteForecasterAction = new RestExecuteForecasterAction();
    ...
    public Collection<Object> createComponents(
        ...
        ADEntityColdStart adEntityColdStarter = new ADEntityColdStart(
            getClock(),
            threadPool,
            stateManager,
            TimeSeriesSettings.NUM_SAMPLES_PER_TREE,
        ...
        ResultIndexingHandler<IndexableResult, ADIndex, ADIndexManagement> anomalyResultHandler = new ResultIndexingHandler<>(
            client,
            settings,
            threadPool,
            ANOMALY_RESULT_INDEX_ALIAS,
        ...
        ForecastIndexMemoryPressureAwareResultHandler forecastIndexMemoryPressureAwareResultHandler =
            new ForecastIndexMemoryPressureAwareResultHandler(client, forecastIndices);
        ...
        // TODO: do we need it in forecast backtesting?
        // ResultBulkIndexingHandler<ForecastResult, ForecastIndex, ForecastIndexManagement> forecastResultBulkIndexHandler = new
        // ResultBulkIndexingHandler<>(
        // client,
        // settings,
        // threadPool,
        ...
        ResultIndexingHandler<IndexableResult, ForecastIndex, ForecastIndexManagement> forecastResultHandler = new ResultIndexingHandler<>(
            client,
            settings,
            threadPool,
        ...
        Map<String, TimeSeriesStat<?>> stats = ImmutableMap
            ...
            .put(
                ...
                new TimeSeriesStat<>(
                    false,
                    new ModelsOnNodeSupplier(adModelManager, adCacheProvider, forecastCacheProvider, settings, clusterService)
                )
            )
            .put(
            ...
            .put(
                ...
                new TimeSeriesStat<>(false, new ModelsOnNodeCountSupplier(adModelManager, adCacheProvider, forecastCacheProvider))
            )
            .build();
    ...
    public List<Setting<?>> getSettings() {
        ...
        List<Setting<?>> systemSetting = ImmutableList
            .of(
                ...
                // Fault tolerance
                ForecastSettings.FORECAST_MAX_RETRY_FOR_UNRESPONSIVE_NODE,

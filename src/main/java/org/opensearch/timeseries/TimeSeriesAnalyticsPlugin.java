...
public class TimeSeriesAnalyticsPlugin extends Plugin implements ActionPlugin, ScriptPlugin, JobSchedulerExtension {
    ...
    public Collection<Object> createComponents(
        ...
        ResultIndexingHandler<AnomalyResult, ADIndex, ADIndexManagement> anomalyResultHandler = new ResultIndexingHandler<>(
            client,
            settings,
            threadPool,
            ANOMALY_RESULT_INDEX_ALIAS,
        ...
        // TODO: use it when writing ExecuteForecastResultResponseRecorder
        // ResultIndexingHandler<ForecastResult, ForecastIndex, ForecastIndexManagement> forecastResultHandler = new
        // ResultIndexingHandler<>(
        // client,
        // settings,
        // threadPool,
        // ForecastCommonName.FORECAST_RESULT_INDEX_ALIAS,

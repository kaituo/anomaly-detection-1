...
import org.opensearch.timeseries.transport.handler.TimeSeriesResultBulkIndexHandler;
...
public class TimeSeriesAnalyticsPlugin extends Plugin implements ActionPlugin, ScriptPlugin, JobSchedulerExtension {
    ...
    public Collection<Object> createComponents(
        ...
        TimeSeriesResultBulkIndexHandler anomalyResultBulkIndexHandler = new TimeSeriesResultBulkIndexHandler(
            client,
            settings,
            threadPool,
            this.clientUtil,
        ...
        TimeSeriesIndexHandler<AnomalyResult> anomalyResultHandler = new TimeSeriesIndexHandler<AnomalyResult>(
            client,
            settings,
            threadPool,

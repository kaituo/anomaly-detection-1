 ...
 */
public class FixedValueInterpolator extends Interpolator {
    private double[] fixedValue;

    public FixedValueInterpolator(double[] fixedValue) {
    ...
    @Override
    protected double[] singleFeatureInterpolate(double[] samples, int numInterpolants) {

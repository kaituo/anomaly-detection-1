...
public class MultiTenantMaintenanceScheduler implements ClusterManagerTask {
    ...
    public void init(
        ...
        eventBridgeHandler
            .setMaintenanceScheduleInterval(DateUtils.toDuration(AnomalyDetectorSettings.AD_CHECKPOINT_SAVING_FREQ.get(settings)));
        ...
        eventBridgeHandler
            .setDailyS3CleanupInterval(DateUtils.toDuration(AnomalyDetectorSettings.AD_DAILY_S3_CLEANUP_INTERVAL.get(settings)));

...
public final class CloudMapWatcherTask implements ClusterManagerTask {
    ...
    public void init(
        ...
        System.out.println("CloudMapWatcherTask init");
    ...
    private void restart() {
        // we should not invoke this method if the node role is not CLOUDMAP_WATCHER_ROLE as addLocalNodeClusterManagerListener is not invoked
        // and thus this class is not registered as a cluster manager listener.
        cancel(cron);

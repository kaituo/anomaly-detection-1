...
public final class ClusterManagerTaskRegistry {
    ...
    public ClusterManagerTaskRegistry(
        ...
        ADCheckpointStore adCheckpointStore,
    ...
    public ClusterManagerTaskRegistry(
        ...
        if (multiTenancyEnabled) {
            JobQueueAccountIdProvider sqsAccountProvider = JobQueueAccountIdProvider
                .find(TimeSeriesSettings.SQS_ACCOUNT_PROVIDER_TYPE.get(settings), settings);
            ADEventBridgeTargetResolver targetResolver = new ADEventBridgeTargetResolver(settings, sqsAccountProvider);
            tasks = List
                .of(
            ...
            tasks = List.of(new ClusterManagerEventListener(client, adCheckpointStore, forecastCheckpointStore)); // checkpoint + hourly
                                                                                                                  // jobs
        }

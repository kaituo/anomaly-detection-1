...
public class IntervalCalculation {
    ...
    public class IntervalRecommendationListener implements ActionListener<SearchResponse> {
        ...
        private void searchWithDifferentInterval(int newIntervalMinuteValue) {
            ...
            dataAccess.searchWithInjectedSecurity(searchRequest, user, TenantContext.user(config.getTenantId()), context, this);
        }
    ...
    public void findMedianIntervalAdaptive(ActionListener<IntervalTimeConfiguration> listener) {
        ...
        dataAccess.searchWithInjectedSecurity(boundsReq, user, TenantContext.user(config.getTenantId()), context, boundsRequestListener);
    }
    ...
    public void refineGap(
        ...
        dataAccess
            .searchWithInjectedSecurity(searchRequest, user, TenantContext.user(config.getTenantId()), context, minIntervalSearchListener);
    }
    ...
    public void runAutoDate(BoolQueryBuilder filter, ActionListener<IntervalTimeConfiguration> listener, ChronoUnit unit, String tsField) {
        ...
        dataAccess
            .searchWithInjectedSecurity(searchRequest, user, TenantContext.user(config.getTenantId()), context, autoDateSearchListener);

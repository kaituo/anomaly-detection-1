...
public class DelegatingDataManagement<IndexType extends Enum<IndexType> & TimeSeriesIndex> implements DataManagement<IndexType> {
    ...
    public DelegatingDataManagement(
        ...
        if (this.multiTenancyEnabled && sdkStore == null) {
            throw new IllegalStateException("Multi-tenancy is enabled but no SDK-backed config store is configured.");
        }
    ...
    private DataManagement<IndexType> delegateStore() {
        return multiTenancyEnabled ? sdkStore : indexStore;
    }
    ...
    public void doesResultIndexExists(String indexName, ActionListener<Boolean> listener, String tenantId) {
        delegate().doesResultIndexExists(indexName, listener, tenantId);
    }

    @Override
    public void doesResultIndexExists(String indexName, ActionListener<Boolean> listener, String tenantId, String dataSourceId) {
        delegate().doesResultIndexExists(indexName, listener, tenantId, dataSourceId);
    }
    ...
    public void doesResultAliasExists(String aliasName, ActionListener<Boolean> listener, String tenantId) {
        delegate().doesResultAliasExists(aliasName, listener, tenantId);
    }

    @Override
    public void doesResultAliasExists(String aliasName, ActionListener<Boolean> listener, String tenantId, String dataSourceId) {
        delegate().doesResultAliasExists(aliasName, listener, tenantId, dataSourceId);
    }
    ...
    public void doesResultIndexOrAliasExists(
        ...
        delegate().doesResultIndexOrAliasExists(indexOrAliasName, listener, tenantId, dataSourceId);
    }
    ...
    public <T> void validateResultIndexAndExecute(
        ...
        delegate().validateResultIndexAndExecute(resultIndexOrAlias, function, mappingValidated, listener, tenantId, dataSourceId);
    }
    ...
    public <T> void initCustomResultIndexAndExecute(
        ...
        delegate().initCustomResultIndexAndExecute(resultIndexOrAlias, function, listener, tenantId, dataSourceId);
    }
    ...
    public void validateResultIndexMapping(
        ...
        delegate().validateResultIndexMapping(resultIndexOrAlias, thenDo, tenantId, dataSourceId);
    }
    ...
    public void initCustomResultIndexDirectly(
        ...
        delegate().initCustomResultIndexDirectly(resultIndex, actionListener, tenantId, dataSourceId);
    }
    ...
    public void initFlattenedResultIndex(
        ...
        delegate().initFlattenedResultIndex(flattenedResultIndexAlias, actionListener, tenantId, dataSourceId);
    }
    ...
    public <T> void validateCustomIndexForBackendJob(
        ...
        delegate()
            .validateCustomIndexForBackendJob(resultIndexOrAlias, securityLogId, user, roles, function, listener, tenantId, dataSourceId);
    }

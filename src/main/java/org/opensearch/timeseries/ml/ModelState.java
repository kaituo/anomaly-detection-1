...
public class ModelState<T> implements org.opensearch.timeseries.ExpiringState {
     ...
     * @param lastProcessedSample last processed sample. Used in interpolation.
     */
    public ModelState(T model, String modelId, String configId, String modelType, Clock clock, Sample lastProcessedSample) {
        this(model, modelId, configId, modelType, clock, 0, lastProcessedSample, Optional.empty(), new ArrayDeque<>());
    }

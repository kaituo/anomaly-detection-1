    ...
    public IntermediateResultType getResult(
        ...
        if (modelState != null) {
            ...
            if (entityModel.isEmpty()) {
                coldStarter.trainModelFromExistingSamples(modelState, entity, config, taskId);
            }

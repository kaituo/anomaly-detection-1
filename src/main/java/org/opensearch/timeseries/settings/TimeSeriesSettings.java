...
public class TimeSeriesSettings {
    ...
    */
    ...
    /**
     * Static model/data node endpoints used for local multi-tenant testing.
     * When configured, coordinator nodes bypass DynamoDB-backed membership reads.
     */
    public static final Setting<List<String>> STATIC_NODES = Setting
        .listSetting("plugins.timeseries.static_nodes", List.of(), s -> s, Setting.Property.NodeScope, Setting.Property.Final);

    /**
     * Enables local-cluster metadata storage for multi-tenant testing when external
     * remote metadata settings are not configured.
     */
    public static final Setting<Boolean> LOCAL_METADATA_STORE_ENABLED = Setting
        .boolSetting("plugins.timeseries.local_metadata_store.enabled", false, Setting.Property.NodeScope, Setting.Property.Final);

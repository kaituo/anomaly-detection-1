 ...
 */
public class IndexStatusSupplier implements TenantAwareStatSupplier<String> {
    ...
    @Override
    public String getForTenant(String tenantId) {
        try {
            return indexOperations.getIndexHealthStatus(tenantId, indexName);

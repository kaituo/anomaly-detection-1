 ...
 */
public interface EntityCache <RCFModelType, ModelState extends TimeSeriesModelState<EntityModel<RCFModelType>>> extends Cache<EntityModel<RCFModelType>, ModelState> {
    /**
     ...
     * for the entity
     */
    ModelState get(String modelId, Config config);
    ...
    */
     ...
     */
    long getLastActiveTime(String detectorId, String entityModelId);
     ...
     * @return Model state
     */
    Optional<ModelState> getForMaintainance(String detectorId, String modelId);

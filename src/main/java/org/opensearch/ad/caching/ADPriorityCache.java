...
public class ADPriorityCache extends
    PriorityCache<ThresholdedRandomCutForest, ADNodeState, ADIndex, ADIndexManagement, ADCheckpointDao, ADCheckpointWriteWorker, ADCheckpointMaintainWorker, ADHCCacheBuffer> {
    ...
    @Override
    protected ADHCCacheBuffer createEmptyCacheBuffer(Config detector, long memoryConsumptionPerEntity) {

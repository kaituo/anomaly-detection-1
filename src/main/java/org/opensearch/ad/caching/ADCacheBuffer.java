...
public class ADCacheBuffer extends
    CacheBuffer<ThresholdedRandomCutForest, ADNodeState, ADNodeStateManager, ADIndex, ADIndexManagement, ADCheckpointDao, ADCheckpointWriteWorker, ADCheckpointMaintainWorker> {

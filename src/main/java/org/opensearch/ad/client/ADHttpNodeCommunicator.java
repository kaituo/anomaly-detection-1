...
public class ADHttpNodeCommunicator extends HttpNodeCommunicator implements ADNodeCommunicator {
    ...
    public ADHttpNodeCommunicator(HashRing hashRing, String internalApiSharedSecret) {
        super(TimeSeriesAnalyticsPlugin.AD_BASE_DETECTORS_URI, ADCommonName.AD_CLUSTER_NAME, hashRing, internalApiSharedSecret);
    }

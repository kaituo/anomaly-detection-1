...
public class AnomalyDetector extends Config {
     ...
     * @param interpolationOption interpolation method and optional default values
     */
    public AnomalyDetector(
        ...
        super(detectorId, version, name, description, timeField,
                ...
                detectionInterval, interpolationOption);
                ...
                case DETECTION_INTERVAL_FIELD:
                    try {
                        ...
                        if (e instanceof IllegalArgumentException
                            && e.getMessage().contains(org.opensearch.timeseries.constant.CommonMessages.NEGATIVE_TIME_CONFIGURATION)) {
                            throw new ValidationException(

...
public class ADTask extends TimeSeriesTask {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (detector != null && (taskType == null || !isRealTimeTask())) {
    ...
    public static ADTask parse(XContentParser parser, String taskId) throws IOException {
        ...
        if (anomalyDetector != null) {
            ...
            anomalyDetector.setDataSourceId(detector.getDataSourceId());
            anomalyDetector.setWorkspaceId(detector.getWorkspaceId());
            anomalyDetector.setS3Reference(detector.getS3Reference());
            anomalyDetector.setEventBridgeCellId(detector.getEventBridgeCellId());
        }
        return new Builder()
            .taskId(parsedTaskId)

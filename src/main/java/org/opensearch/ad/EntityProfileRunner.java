            ...
            if (getResponse != null && getResponse.isExists()) {
                try (
                    ...
                    if (categoryFields == null || categoryFields.size() == 0) {
                        ...
                        listener
                            .onFailure(new IllegalArgumentException(CommonMessages.getTooManyCategoricalFieldErr(maxCategoryFields)));
                    } else {
                ...
                try (
                    ...
                    if (profilesToCollect.contains(EntityProfileName.ENTITY_INFO)) {
                        ...
                        client.search(lastSampleTimeRequest, ActionListener.wrap(searchResponse -> {
                            Optional<Long> latestSampleTimeMs = ADParseUtils.getLatestDataTime(searchResponse);

...
public class ADRealTimeInferencer extends
    RealTimeInferencer<ThresholdedRandomCutForest, AnomalyResult, ThresholdingResult, ADIndex, ADIndexManagement,
        ADCheckpointDao, ADCheckpointWriteWorker, ADColdStart, ADModelManager, ADSaveResultStrategy, ADPriorityCache,
        ADTaskCacheManager, ADTaskType, ADTask, ADTaskManager, ADColdStartWorker> {

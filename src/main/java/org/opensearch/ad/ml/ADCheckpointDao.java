 ...
 */
public class ADCheckpointDao extends CheckpointDao<ThresholdedRandomCutForest, ADIndex, ADIndexManagement, ADCheckpointCodec>
    implements
        ADCheckpointStore {
    ...
    public ADCheckpointDao(
        ...
        super(
            ...
            indexUtil,
            new ADCheckpointCodec(maxCheckpointBytes, trcfSchema, trcfMapper, converter, gson, mapper, thresholdingModelClass, anomalyRate, clock, serializeRCFBufferPool, serializeRCFBufferSize, indexUtil)
        );

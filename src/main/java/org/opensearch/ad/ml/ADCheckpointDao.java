 ...
 */
public class ADCheckpointDao extends TimeSeriesCheckpointDao<ThresholdedRandomCutForest> {
    ...
    @SuppressWarnings("unchecked")
    @Override
    protected <ModelStateType extends TimeSeriesModelState<EntityModel<ThresholdedRandomCutForest>>> ModelStateType fromEntityModelCheckpoint
    (Map<String, Object> checkpoint, String modelId, String configId) {
        try {
            return (ModelStateType) AccessController.doPrivileged((PrivilegedAction<ADModelState<EntityModel<ThresholdedRandomCutForest>>>) () -> {

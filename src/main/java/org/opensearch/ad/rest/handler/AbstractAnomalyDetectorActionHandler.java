 ...
 *  </ul>
 */
public abstract class AbstractAnomalyDetectorActionHandler<T extends ActionResponse> extends AbstractTimeSeriesActionHandler<T> {
    ...
    public AbstractAnomalyDetectorActionHandler(
        ...
        super(anomalyDetector, anomalyDetectionIndices, isDryRun, client, detectorId, clientUtil, user, method,
                clusterService, xContentRegistry, transportService, requestTimeout, refreshPolicy, seqNo, primaryTerm,
                validationType, searchFeatureDao, maxFeatures, maxCategoricalFields);
    ...
    protected String getExceedMaxSingleStreamConfigsErrorMsg(int maxSingleStreamConfigs) {
        return String
        .format(Locale.ROOT, EXCEEDED_MAX_SINGLE_STREAM_DETECTORS_PREFIX_MSG, getMaxSingleStreamConfigs());
    }

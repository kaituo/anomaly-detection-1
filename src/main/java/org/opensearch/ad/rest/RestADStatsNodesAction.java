...
/**
 * REST handler for AD node stats.
 */
public class RestADStatsNodesAction extends RestStatsAction {
    ...
    private static final String STATS_NODES_PATH = AD_BASE_DETECTORS_URI + "/" + RestHandlerUtils.STATS_NODES;
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) {
        ...
        StatsRequest statsRequest = getRequest(request, tenantId);
        return channel -> client.execute(ADStatsNodesAction.INSTANCE, statsRequest, new RestToXContentListener<>(channel));
    }

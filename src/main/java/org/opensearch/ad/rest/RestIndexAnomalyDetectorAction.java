...
public class RestIndexAnomalyDetectorAction extends AbstractAnomalyDetectorAction {
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        maybePromoteDevTestHeadersToTransients(request, method, client);
    ...
    private void maybePromoteDevTestHeadersToTransients(RestRequest request, RestRequest.Method method, NodeClient client) {

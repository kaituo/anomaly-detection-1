...
public class RestEntityADResultAction extends BaseRestHandler {
    ...
    public RestEntityADResultAction(Settings settings, ADStats adStats) {
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> {
            ...
            client.execute(EntityADResultAction.INSTANCE, entityResultRequest, new RestToXContentListener<AcknowledgedResponse>(channel));
        };
    }

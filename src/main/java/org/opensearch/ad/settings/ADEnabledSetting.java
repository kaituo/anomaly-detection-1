...
import org.opensearch.timeseries.settings.AbstractSetting;

public class ADEnabledSetting extends AbstractSetting {
    ...
    public static final Map<String, Setting<?>> settings = unmodifiableMap(new HashMap<String, Setting<?>>() {
        {
            Setting LegacyADEnabledSetting = Setting
                .boolSetting(LEGACY_OPENDISTRO_AD_ENABLED, true, NodeScope, Dynamic, Deprecated);
            /**
    ...
    private ADEnabledSetting(Map<String, Setting<?>> settings) {
        super(settings);
    }

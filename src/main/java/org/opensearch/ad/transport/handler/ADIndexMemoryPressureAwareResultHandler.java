...
public class ADIndexMemoryPressureAwareResultHandler extends
    ...
    @Inject
    public ADIndexMemoryPressureAwareResultHandler(Client client, ADIndexManagement anomalyDetectionIndices) {
        super(client, anomalyDetectionIndices);
    }

    @Override
    public void bulk(ADResultBulkRequest currentBulkRequest, ActionListener<ResultBulkResponse> listener) {

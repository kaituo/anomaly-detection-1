...
public class ADResultBulkTransportAction extends TimeSeriesResultBulkTransportAction<ADResultBulkRequest> {
    ...
    public ADResultBulkTransportAction(
        ...
        super(ADResultBulkAction.NAME, transportService, actionFilters, indexingPressure, settings,
                client,

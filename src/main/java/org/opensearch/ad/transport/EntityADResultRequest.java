...
public class EntityADResultRequest extends ActionRequest implements ToXContentObject {
    private static final Logger LOG = LogManager.getLogger(EntityADResultRequest.class);
    ...
    public EntityADResultRequest(StreamInput in) throws IOException {
        super(in);
    ...
    public EntityADResultRequest(String detectorId, Map<Entity, double[]> entities, long start, long end) {
        super();

...
import org.opensearch.timeseries.transport.TimeSeriesResultRequest;

public class AnomalyResultRequest extends TimeSeriesResultRequest {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        builder.startObject();
        builder.field(ADCommonName.ID_JSON_KEY, id);

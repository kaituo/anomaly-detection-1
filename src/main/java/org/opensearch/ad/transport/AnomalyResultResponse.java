...
public class AnomalyResultResponse extends ResultResponse {
    ...
    public static ResultResponse fromActionResponse(final ActionResponse actionResponse) {
        if (actionResponse instanceof AnomalyResultResponse) {
            return (ResultResponse) actionResponse;
        }

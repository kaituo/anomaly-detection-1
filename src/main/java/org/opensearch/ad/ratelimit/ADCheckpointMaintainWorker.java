...
public class ADCheckpointMaintainWorker extends
    CheckpointMaintainWorker<ADNodeState, ThresholdedRandomCutForest, ADIndex, ADIndexManagement, ADCheckpointDao> {
    ...
    public ADCheckpointMaintainWorker(
        ...
        CheckPointMaintainRequestAdapter<ThresholdedRandomCutForest, ADIndex, ADIndexManagement, ADCheckpointDao> adapter
    ) {
        super(
            WORKER_NAME,
            heapSizeInBytes,

...
public class ADColdStartWorker extends
    ColdStartWorker<ADNodeState, ADNodeStateManager, ThresholdedRandomCutForest, ADIndex, ADIndexManagement, ADCheckpointDao, ADCheckpointWriteWorker, ADEntityColdStart, ADPriorityCache> {

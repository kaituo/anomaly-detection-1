...
public class ADColdStartWorker extends
    ColdStartWorker<ADNodeState, ThresholdedRandomCutForest, ADIndex, ADIndexManagement, ADCheckpointDao, ADCheckpointWriteWorker, ADEntityColdStart, ADPriorityCache> {

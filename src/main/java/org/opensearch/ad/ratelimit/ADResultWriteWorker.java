...
public class ADResultWriteWorker extends
    ...
    @Override
    protected ADResultBulkRequest toBatchRequest(List<ADResultWriteRequest> toProcess, String tenantId) {
        final ADResultBulkRequest bulkRequest = new ADResultBulkRequest(tenantId);

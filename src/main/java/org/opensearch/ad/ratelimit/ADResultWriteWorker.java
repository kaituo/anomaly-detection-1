...
public class ADResultWriteWorker extends
    ResultWriteWorker<AnomalyResult, ADResultWriteRequest, ADResultBulkRequest, ADNodeState, ADIndex, ADIndexManagement, ADIndexMemoryPressureAwareResultHandler> {

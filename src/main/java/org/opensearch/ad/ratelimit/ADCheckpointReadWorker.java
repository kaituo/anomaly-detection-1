 ...
 *
 */
public class ADCheckpointReadWorker<ModelStateType, ModelState extends ADModelState<ModelStateType>> extends
        TimeSeriesHCCheckpointReadWorker<ADNodeState, ThresholdedRandomCutForest, AnomalyResult, ADResultWriteRequest, ADResultBulkRequest, ADModelState<EntityModel<ThresholdedRandomCutForest>>, ThresholdingResult, ADModelManager, ADCheckpointDao> {
    ...
    public ADCheckpointReadWorker(
        ...
        EntityCacheProvider<ThresholdedRandomCutForest, ADModelState<EntityModel<ThresholdedRandomCutForest>>> cacheProvider,
        Duration stateTtl,
    ...
    @Override
    protected void saveResult(ThresholdingResult result, Config config, EntityFeatureRequest origRequest, Entity entity,
            String modelId) {

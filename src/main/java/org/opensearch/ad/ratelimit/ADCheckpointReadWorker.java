...
public class ADCheckpointReadWorker extends
    CheckpointReadWorker<ThresholdedRandomCutForest, AnomalyResult, ThresholdingResult, ADIndex, ADIndexManagement, ADCheckpointDao, ADCheckpointWriteWorker, ADEntityColdStart, ADModelManager, ADPriorityCache, ADSaveResultStrategy, ADColdStartWorker> {

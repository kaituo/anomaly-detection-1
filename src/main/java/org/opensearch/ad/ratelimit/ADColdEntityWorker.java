...
public class ADColdEntityWorker extends
    ColdEntityWorker<ThresholdedRandomCutForest, AnomalyResult, ADResultWriteRequest, ADResultBulkRequest, ADIndex, ADIndexManagement, ADCheckpointDao, ThresholdingResult, ADModelManager, ADCheckpointWriteWorker, ADEntityColdStart, ADPriorityCache, ADColdStartWorker, ADIndexMemoryPressureAwareResultHandler, ADResultWriteWorker, ADCheckpointReadWorker> {

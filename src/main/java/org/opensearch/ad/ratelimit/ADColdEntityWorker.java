...
public class ADColdEntityWorker extends
    ColdEntityWorker<ThresholdedRandomCutForest, AnomalyResult, ADIndex, ADDelegatingDataManagement, ADCheckpointStore, ThresholdingResult, ADModelManager, ADCheckpointWriteWorker, ADColdStart, ADPriorityCache, ADSaveResultStrategy, ADTaskCacheManager, ADTaskType, ADTask, ADTaskManager, ADColdStartWorker, ADRealTimeInferencer, ADCheckpointReadWorker> {

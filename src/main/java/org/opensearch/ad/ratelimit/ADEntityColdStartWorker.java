...
public class ADEntityColdStartWorker extends TimeSeriesColdStartWorker<ADNodeState, ThresholdedRandomCutForest, ADModelState<EntityModel<ThresholdedRandomCutForest>>> {
    private static final Logger LOG = LogManager.getLogger(ADEntityColdStartWorker.class);
    ...
    public ADEntityColdStartWorker(
        ...
        CacheProvider<ThresholdedRandomCutForest, TimeSeriesModelState<EntityModel<ThresholdedRandomCutForest>>> cacheProvider
    ) {
        super(
            WORKER_NAME,
            heapSizeInBytes,

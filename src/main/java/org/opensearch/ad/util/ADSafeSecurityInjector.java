...
public class ADSafeSecurityInjector extends SafeSecurityInjector {
    ...
    public ADSafeSecurityInjector(String detectorId, Settings settings, ThreadContext tc, ADNodeStateManager stateManager) {
    ...
    public void injectUserRolesFromDetector(ActionListener<Void> injectListener) {
        ...
        ActionListener<Optional<? extends AnomalyDetector>> getDetectorListener = ActionListener.wrap(detectorOp -> {

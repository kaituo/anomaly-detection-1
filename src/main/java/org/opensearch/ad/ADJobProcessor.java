...
public class ADJobProcessor extends
    JobProcessor<ADIndex, ADDelegatingDataManagement, ADTaskCacheManager, ADTaskType, ADTask, ADTaskManager, AnomalyResult, ExecuteADResultResponseRecorder, ADIndexJobActionHandler> {
    ...
    protected void validateResultIndexAndRunJob(
        ...
        }, listener, detector.getTenantId(), detector.getDataSourceId());
    }
}

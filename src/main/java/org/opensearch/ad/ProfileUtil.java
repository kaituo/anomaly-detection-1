...
public class ProfileUtil {
    ...
    public static void confirmMultiEntityDetectorInitStatus(
    ...
    public static InitProgressProfile computeInitProgressProfile(long totalUpdates, long intervalMins, long requiredSamples) {

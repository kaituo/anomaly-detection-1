...
public class ExecuteADResultResponseRecorder extends
    ExecuteResultResponseRecorder<ADIndex, ADIndexManagement, ADTaskCacheManager, ADTaskType, ADTask, ADTaskManager> {

    public ExecuteADResultResponseRecorder(
        ADIndexManagement indexManagement,
        ResultIndexingHandler<IndexableResult, ADIndex, ADIndexManagement> resultHandler,

...
import static org.opensearch.ad.ml.ADModelState.LAST_CHECKPOINT_TIME_KEY;
import static org.opensearch.ad.ml.ADModelState.LAST_USED_TIME_KEY;
import static org.opensearch.ad.ml.ADModelState.MODEL_TYPE_KEY;
...
public class ModelsOnNodeSupplier implements Supplier<List<Map<String, Object>>> {
     ...
     */
    public ModelsOnNodeSupplier(ADModelManager modelManager, EntityCacheProvider cache, Settings settings, ClusterService clusterService) {

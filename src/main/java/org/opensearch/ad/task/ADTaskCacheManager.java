...
import static org.opensearch.ad.ADMemoryTracker.Origin.HISTORICAL_SINGLE_ENTITY_DETECTOR;
...
public class ADTaskCacheManager {
    ...
    private final ADMemoryTracker memoryTracker;
     ...
     */
    public ADTaskCacheManager(Settings settings, ClusterService clusterService, ADMemoryTracker memoryTracker) {
    ...
    public void initRealtimeTaskCache(String detectorId, long detectorIntervalInMillis) {
        realtimeTaskCaches.put(detectorId, new RealtimeTaskCache(null, null, null, detectorIntervalInMillis));

...
public class ForecastEnabledSetting extends AbstractSetting {
    ...
    public static final Map<String, Setting<?>> settings = unmodifiableMap(new HashMap<String, Setting<?>>() {
        {
             ...
             */
            put(FORECAST_DOOR_KEEPER_IN_CACHE_ENABLED, Setting.boolSetting(FORECAST_DOOR_KEEPER_IN_CACHE_ENABLED, false, NodeScope, Dynamic));
        }
    });

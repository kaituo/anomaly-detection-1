...
public class ForecastPriorityCache extends
    PriorityCache<RCFCaster, NodeState, ForecastNodeStateManager, ForecastIndex, ForecastIndexManagement, ForecastCheckpointDao, ForecastCheckpointWriteWorker, ForecastCheckpointMaintainWorker, ForecastCacheBuffer> {
    ...
    @Override
    protected ForecastCacheBuffer createEmptyCacheBuffer(Config config, long requiredMemory) {

...
public class ForecastCacheBuffer extends
    CacheBuffer<RCFCaster, ForecastIndex, ForecastDelegatingDataManagement, ForecastCheckpointDao, ForecastCheckpointWriteWorker, ForecastCheckpointMaintainWorker> {

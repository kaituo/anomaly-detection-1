...
public class ForecastJobProcessor extends
    JobProcessor<ForecastIndex, ForecastIndexManagement, TaskCacheManager, ForecastTaskType, ForecastTask, ForecastTaskManager, ExecuteForecastResultResponseRecorder> {
    ...
    public void process(Job jobParameter, JobExecutionContext context) {
        ...
        log.info("Start to run forecast job {}", detectorId);
    }

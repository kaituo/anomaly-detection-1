...
public class ForecastCheckpointMaintainWorker extends
    CheckpointMaintainWorker<NodeState, ForecastNodeStateManager, RCFCaster, ForecastIndex, ForecastIndexManagement, ForecastCheckpointDao> {
    ...
    public ForecastCheckpointMaintainWorker(
        ...
        RateLimitedRequestWorker<CheckpointWriteRequest, NodeState, ForecastNodeStateManager> targetQueue,
        Duration stateTtl,

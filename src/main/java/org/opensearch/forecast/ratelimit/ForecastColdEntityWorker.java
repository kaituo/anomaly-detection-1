...
public class ForecastColdEntityWorker extends
    ColdEntityWorker<NodeState, ForecastNodeStateManager, RCFCaster, ForecastResult, ForecastResultWriteRequest, ForecastResultBulkRequest, ForecastIndex, ForecastIndexManagement, ForecastCheckpointDao, RCFCasterResult, ForecastModelManager, ForecastCheckpointWriteWorker, ForecastColdStart, ForecastPriorityCache, ForecastColdStartWorker, ForecastIndexMemoryPressureAwareResultHandler, ForecastResultWriteWorker, ForecastCheckpointReadWorker> {

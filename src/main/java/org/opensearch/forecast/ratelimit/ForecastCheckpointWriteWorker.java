...
public class ForecastCheckpointWriteWorker extends
    CheckpointWriteWorker<NodeState, ForecastNodeStateManager, RCFCaster, ForecastIndex, ForecastIndexManagement, ForecastCheckpointDao> {
    ...
    public ForecastCheckpointWriteWorker(
        ...
        Duration stateTtl,
        ForecastNodeStateManager timeSeriesNodeStateManager,

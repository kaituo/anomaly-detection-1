...
public class ForecastCheckpointWriteWorker extends TimeSeriesCheckpointWriteWorker<ForecastNodeState> {
    ...
    public ForecastCheckpointWriteWorker(long heapSize, int singleRequestSize,
            ...
            TimeSeriesCheckpointDao checkpoint, String indexName, Duration checkpointInterval) {

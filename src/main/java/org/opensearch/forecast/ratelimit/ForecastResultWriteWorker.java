...
public class ForecastResultWriteWorker extends
    ResultWriteWorker<ForecastResult, ForecastResultWriteRequest, ForecastResultBulkRequest, NodeState, ForecastIndex, ForecastIndexManagement, ForecastIndexMemoryPressureAwareResultHandler> {

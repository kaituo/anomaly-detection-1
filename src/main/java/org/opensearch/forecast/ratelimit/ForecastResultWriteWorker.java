...
public class ForecastResultWriteWorker extends
    ResultWriteWorker<ForecastResult, ForecastResultWriteRequest, ForecastResultBulkRequest, NodeState, ForecastNodeStateManager, ForecastIndex, ForecastIndexManagement, ForecastIndexMemoryPressureAwareResultHandler> {

...
public class ForecastResultWriteWorker extends
    ...
    @Override
    protected ForecastResultBulkRequest toBatchRequest(List<ForecastResultWriteRequest> toProcess, String tenantId, String dataSourceId) {
        final ForecastResultBulkRequest bulkRequest = new ForecastResultBulkRequest(tenantId, dataSourceId);

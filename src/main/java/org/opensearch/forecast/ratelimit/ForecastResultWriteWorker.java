...
import org.opensearch.forecast.transport.handler.ForecastHCResultHandler;
...
public class ForecastResultWriteWorker extends TimeSeriesResultWriteWorker<ForecastResult, ForecastResultWriteRequest, ForecastResultBulkRequest, ForecastNodeState> {
    ...
    public ForecastResultWriteWorker(
        ...
        ForecastHCResultHandler resultHandler,

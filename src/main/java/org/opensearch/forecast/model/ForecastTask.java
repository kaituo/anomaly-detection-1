...
import org.opensearch.ad.model.ADTask.Builder;
...
public class ForecastTask extends TimeSeriesTask {
    ...
    private String forecasterId = null;
    ...
    public ForecastTask(StreamInput input) throws IOException {
        ...
        this.forecasterId = input.readOptionalString();
    ...
    public boolean isEntityTask() {
        return ForecastTaskType.HISTORICAL_HC_ENTITY.name().equals(taskType);
    }
    ...
    public static class Builder extends TimeSeriesTask.Builder<Builder> {
        ...
        public Builder forecasterId(String forecasterId) {
        ...
        public ForecastTask build() {
            ...
            forecastTask.forecasterId = this.forecasterId;
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (forecasterId != null) {
            xContentBuilder.field(FORECASTER_ID_FIELD, forecasterId);
        }
        if (forecaster != null) {
    ...
    public boolean equals(Object other) {
        ...
        return super.equals(that)
                && Objects.equal(getForecasterId(), that.getForecasterId())
    ...
    public int hashCode() {
        ...
        int hash = Objects
                .hashCode(
                        forecasterId, forecaster, dateRange);
    ...
    public String getEntityModelId() {
        return entity == null ? null : entity.getModelId(forecasterId).orElse(null);
    }

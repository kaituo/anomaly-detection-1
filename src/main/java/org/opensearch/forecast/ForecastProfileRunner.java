...
public class ForecastProfileRunner extends
    ProfileRunner<TaskCacheManager, ForecastTaskType, ForecastTask, ForecastIndex, ForecastIndexManagement, ForecastTaskProfile, ForecastTaskManager, ForecasterProfile, ForecastProfileAction> {

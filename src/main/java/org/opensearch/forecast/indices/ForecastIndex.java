...
import org.opensearch.timeseries.util.ThrowingSupplierWrapper;
...
public enum ForecastIndex implements TimeSeriesIndex {
    ...
    RESULT(
        ...
        true,
        ThrowingSupplierWrapper.throwingSupplierWrapper(ForecastIndexManagement::getForecastResultMappings)
    ),
    ...
    STATE(
        ...
        false,
        ThrowingSupplierWrapper.throwingSupplierWrapper(ForecastIndexManagement::getForecastStateMappings)
    );

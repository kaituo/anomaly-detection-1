...
public abstract class AbstractForecasterActionHandler<T extends ActionResponse> extends AbstractTimeSeriesActionHandler<T> {
    ...
    public static final String EXCEEDED_MAX_SINGLE_STREAM_FORECASTERS_PREFIX_MSG =
        "Can't create more than %d single-stream forecasters.";
    ...
    public AbstractForecasterActionHandler(
        ...
        super(forecaster, forecastIndices, isDryRun, client, forecasterId, clientUtil, user, method,
                clusterService, xContentRegistry, transportService, requestTimeout, refreshPolicy,
                seqNo, primaryTerm, validationType, searchFeatureDao, maxFeatures, maxCategoricalFields);
    ...
    protected String getExceedMaxSingleStreamConfigsErrorMsg(int maxSingleStreamConfigs) {
        return String
        .format(Locale.ROOT, EXCEEDED_MAX_SINGLE_STREAM_FORECASTERS_PREFIX_MSG, getMaxSingleStreamConfigs());
    }

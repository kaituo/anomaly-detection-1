...
public class RestSearchForecasterInfoAction extends BaseRestHandler {
    ...
    public List<RestHandler.Route> routes() {
        return ImmutableList.of(
                new Route(RestRequest.Method.GET, String.format(Locale.ROOT, "%s/%s", TimeSeriesAnalyticsPlugin.FORECAST_FORECASTERS_URI, COUNT)),
                new Route(RestRequest.Method.GET, String.format(Locale.ROOT, "%s/%s", TimeSeriesAnalyticsPlugin.FORECAST_FORECASTERS_URI, MATCH))
                );
    }
}

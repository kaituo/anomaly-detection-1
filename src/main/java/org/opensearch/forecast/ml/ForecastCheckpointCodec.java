...
public class ForecastCheckpointCodec extends CheckpointCodec<RCFCaster> {
    ...
    private final ForecastIndexManagement indexUtil;
    
    public ForecastCheckpointCodec(Clock clock, int maxCheckpointBytes, RCFCasterMapper mapper, Schema<RCFCasterState> rcfCasterSchema, GenericObjectPool<LinkedBuffer> serializeRCFBufferPool, int serializeRCFBufferSize,
     ...
     */
    @Override
    public ModelState<RCFCaster> fromEntityModelCheckpoint(Map<String, Object> checkpoint, String modelId, String configId) {
        try {

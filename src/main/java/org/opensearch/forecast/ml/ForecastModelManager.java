...
public class ForecastModelManager extends
    ModelManager<RCFCaster, NodeState, RCFCasterResult, ForecastIndex, ForecastIndexManagement, ForecastCheckpointDao, ForecastCheckpointWriteWorker, ForecastColdStart> {
    ...
    protected <RCFDescriptor extends AnomalyDescriptor> RCFCasterResult toResult(RandomCutForest forecast, RCFDescriptor castDescriptor) {
        if (castDescriptor instanceof ForecastDescriptor) {
            ...
            throw new IllegalArgumentException("Unsupported type of AnomalyDescriptor");
        }
    }
}

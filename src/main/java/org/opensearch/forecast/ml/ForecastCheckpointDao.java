...
public class ForecastCheckpointDao extends CheckpointDao<RCFCaster, ForecastIndex, ForecastIndexManagement> {
    ...
    public Map<String, Object> toIndexSource(ModelState<RCFCaster> modelState) throws IOException {
        ...
        Optional<byte[]> serializedModel = toCheckpoint(model);
        ...
        try {
            return AccessController.doPrivileged((PrivilegedAction<ModelState<RCFCaster>>) () -> {
                ...
                ModelState<RCFCaster> modelState = new ModelState<RCFCaster>(
                    ...
                    clock,
                    0,
                    loadLastProcessedSample(checkpoint, modelId),
    ...
    private RCFCaster loadRCFCaster(Map<String, Object> checkpoint, String modelId) {
        byte[] model = (byte[]) checkpoint.get(CommonName.FIELD_MODEL);
    ...
    private Sample loadLastProcessedSample(Map<String, Object> checkpoint, String modelId) {
        String lastProcessedSampleStr = (String) checkpoint.get(LAST_PROCESSED_SAMPLE_FIELD);
            ...
            return Sample
                .parse(
                    JsonXContent.jsonXContent
                        .createParser(NamedXContentRegistry.EMPTY, DeprecationHandler.IGNORE_DEPRECATIONS, lastProcessedSampleStr)
                );
        } catch (Exception e) {
    ...
    private Deque<Sample> loadSampleQueue(Map<String, Object> checkpoint, String modelId) {

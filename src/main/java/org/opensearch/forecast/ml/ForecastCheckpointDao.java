 ...
 *
 */
public class ForecastCheckpointDao extends CheckpointDao<RCFCaster, ForecastIndex, ForecastIndexManagement, ForecastCheckpointCodec> {
    ...
    public ForecastCheckpointDao(
        ...
        super(
            ...
            indexUtil,
            new ForecastCheckpointCodec(clock, maxCheckpointBytes, mapper, rcfCasterSchema, serializeRCFBufferPool, serializeRCFBufferSize, indexUtil)
        );
        this.mapper = mapper;
        this.clock = clock;
    }

 ...
 *
 */
public class ForecastCheckpointDao extends TimeSeriesCheckpointDao<RCFCaster, ForecastModelState<EntityModel<RCFCaster>>> {
    ...
    /**
     * Process a checkpoint GetResponse and return the EntityModel object. Used in HC forecasting.
     * @param response Checkpoint Index GetResponse
     * @param modelId  Model Id
     * @return a pair of entity model and its last checkpoint time
     */
    @Override
    public Optional<ForecastModelState<EntityModel<RCFCaster>>> processGetResponse(GetResponse response, String modelId, String configId) {
     ...
     */
    @Override
    protected Optional<ForecastModelState<EntityModel<RCFCaster>>> fromEntityModelCheckpoint(Map<String, Object> checkpoint, String modelId, String configId) {
        try {
            return AccessController.doPrivileged((PrivilegedAction<Optional<ForecastModelState<EntityModel<RCFCaster>>>>) () -> {
                ...
                EntityModel<RCFCaster> entityModel = new EntityModel<>(entity, sampleQueue, rcfCaster);

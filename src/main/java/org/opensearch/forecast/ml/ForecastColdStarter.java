...
public class ForecastColdStarter extends TimeSeriesColdStarter<ForecastNodeState> {
    private static final Logger logger = LogManager.getLogger(ForecastColdStarter.class);
    ...
    protected void trainModelFromDataSegments(Pair<double[][], Sample> pointSamplePair, Optional<Entity> entity,
        ...
        RCFCaster.Builder casterBuilder = RCFCaster.builder().dimensions(dimensions).numberOfTrees(numberOfTrees)
                ...
                .timeDecay(rcfTimeDecay).parallelExecutionEnabled(false).boundingBoxCacheFraction(AnomalyDetectorSettings.REAL_TIME_BOUNDING_BOX_CACHE_RATIO)

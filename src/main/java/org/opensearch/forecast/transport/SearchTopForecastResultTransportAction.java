...
//            List<String> categoryFieldsFromResponse = getForecasterResponse.getForecaster().getCategoryFields();
...
//                request.setSplitBy(categoryFieldsFromResponse);
//            } else {
//                for (String categoryField : request.getSplitBy()) {
//                    if (!categoryFieldsFromResponse.contains(categoryField)) {
//                        throw new IllegalArgumentException(
//                            String.format(Locale.ROOT, "Category field %s doesn't exist for forecaster ID %s", categoryField, request.getForecasterId())
//                        );
//                    }
//                }
//            }
...
//            String rawCustomResultIndex = getForecasterResponse.getDetector().getCustomResultIndex();
...
//        private ActionListener<SearchTopForecastResultResponse> listener;
...
//                if (afterKey == null) {
//                    listener.onResponse(new SearchTopForecastResultResponse(getDescendingOrderListFromHeap(topResultsHeap)));
...
//     */
//    private SearchRequest generateSearchRequest(SearchTopForecastResultRequest request) {
...
//     */
//    private QueryBuilder generateQuery(SearchTopForecastResultRequest request) {
...
//     */
//    private AggregationBuilder generateAggregation(SearchTopForecastResultRequest request) {

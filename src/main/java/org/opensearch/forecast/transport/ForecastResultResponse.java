...
public class ForecastResultResponse extends ResultResponse {
    ...
    public ForecastResultResponse(
        ...
        this(Double.NaN, features, error, rcfTotalUpdates, forecasterIntervalInMinutes, isHCForecaster, null, null, null);
    }

...
public class GetForecasterResponse extends ActionResponse implements ToXContentObject {
    ...
    private ForecastTask historicalTask;
    ...
    public GetForecasterResponse(StreamInput in) throws IOException {
        ...
        if (profileResponse) {
            ...
            if (in.readBoolean()) {
                historicalTask = new ForecastTask(in);
            } else {
                historicalTask = null;
            }
        }
    ...
    public GetForecasterResponse(
        ...
        if (this.returnTask) {
            ...
            this.historicalTask = historicalTask;
        } else {
            this.realtimeTask = null;
            this.historicalTask = null;
        }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        if (profileResponse) {
            ...
            if (returnTask) {
                ...
                builder.field(RestHandlerUtils.HISTORICAL_ANALYSIS_TASK, historicalTask);
            }
            builder.endObject();
        }
        return builder;
    ...
    public ForecastTask getHistoricalTask() {

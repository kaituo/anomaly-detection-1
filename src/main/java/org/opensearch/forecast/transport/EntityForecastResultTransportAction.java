...
public class EntityForecastResultTransportAction extends HandledTransportAction<EntityResultRequest, AcknowledgedResponse> {
    ...
    private HCCacheProvider<RCFCaster> cache;
    private final ForecastNodeStateManager stateManager;
    private ThreadPool threadPool;
    private EntityResultProcessor<RCFCaster, NodeState, RCFCasterResult, ForecastIndex, ForecastIndexManagement, ForecastResult, ForecastResultWriteRequest, ForecastResultBulkRequest, ForecastCheckpointDao, ForecastCheckpointWriteWorker, ForecastColdStart, ForecastModelManager, ForecastPriorityCache, ForecastColdStartWorker, ForecastIndexMemoryPressureAwareResultHandler, ForecastResultWriteWorker, ForecastCheckpointReadWorker, ForecastColdEntityWorker> intervalDataProcessor;
    ...
    public EntityForecastResultTransportAction(
        ...
        HCCacheProvider<RCFCaster> entityCache,

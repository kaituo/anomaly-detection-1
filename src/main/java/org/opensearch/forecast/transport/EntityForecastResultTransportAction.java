...
public class EntityForecastResultTransportAction extends HandledTransportAction<EntityResultRequest, AcknowledgedResponse> {
    ...
    private EntityResultProcessor<RCFCaster, RCFCasterResult, ForecastIndex, ForecastIndexManagement, ForecastResult, ForecastResultWriteRequest, ForecastResultBulkRequest, ForecastCheckpointDao, ForecastCheckpointWriteWorker, ForecastColdStart, ForecastModelManager, ForecastPriorityCache, ForecastColdStartWorker, ForecastIndexMemoryPressureAwareResultHandler, ForecastResultWriteWorker, ForecastCheckpointReadWorker, ForecastColdEntityWorker> intervalDataProcessor;
    ...
    public EntityForecastResultTransportAction(
        ...
        CacheProvider<RCFCaster, ForecastPriorityCache> entityCache,
        ...
        try {
            ...
            stateManager
                .getConfig(
                    forecasterId,
                    Context.FORECAST,
                    intervalDataProcessor.onGetConfig(listener, forecasterId, request, previousException)
                );

...
public class DeleteForecastModelTransportAction extends
    BaseDeleteModelTransportAction<RCFCaster, ForecastPriorityCache, ForecastCacheProvider, TaskCacheManager, ForecastIndex,
    ForecastIndexManagement, ForecastCheckpointDao, ForecastCheckpointWriteWorker, ForecastResult, ForecastColdStart> {

...
public class ForecasterJobTransportAction extends
    BaseJobTransportAction<ForecastIndex, ForecastIndexManagement, TaskCacheManager, ForecastTaskType, ForecastTask, ForecastTaskManager, ForecastResult, ExecuteForecastResultResponseRecorder, ForecastIndexJobActionHandler> {

...
public class ForecastJobResponse extends ActionResponse implements ToXContentObject {
    ...
    public ForecastJobResponse(StreamInput in) throws IOException {
        super(in);
        id = in.readString();
        version = in.readLong();
        seqNo = in.readLong();
    ...
    public ForecastJobResponse(String id, long version, long seqNo, long primaryTerm, RestStatus restStatus) {
        this.id = id;

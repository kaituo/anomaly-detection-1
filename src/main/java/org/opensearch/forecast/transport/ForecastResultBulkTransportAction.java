...
import org.opensearch.timeseries.transport.TimeSeriesResultBulkTransportAction;
import org.opensearch.transport.TransportService;

public class ForecastResultBulkTransportAction extends TimeSeriesResultBulkTransportAction<ForecastResultBulkRequest> {
    ...
    public ForecastResultBulkTransportAction(
        ...
        super(ForecastResultBulkAction.NAME, transportService, actionFilters, indexingPressure, settings,
                client,
